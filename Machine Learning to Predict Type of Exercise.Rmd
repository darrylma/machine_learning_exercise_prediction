...
From the output above, we see that the decision tree does not accurately predict the outcome, classe, very well only achieving `r round(rpart_acc[[1]]*100, digits=1)`% accuracy. The confusion matrix further shows us that this model was particularly very poor at classifying class D, which is corroborated by the dendrogram, where there is no node that classifies any observation as class D. 
...
From the output above, we see that the random forest accurately predicts the outcome, classe, very well, achieving `r round(rf_acc[[1]]*100, digits=1)`% accuracy on the validation set. 
...
From the output above, we see that the gradient boost model accurately predicts the outcome, classe, very well, achieving `r round(gbm_acc[[1]]*100, digits=1)`% accuracy on the validation set. 
